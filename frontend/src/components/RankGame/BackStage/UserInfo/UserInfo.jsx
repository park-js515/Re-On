...
// };
return (
  <div className="userbox relative bg-gray my-8 mt-28 py-12 sm:py-22" ref={containerRef}>
          ...
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <div className="mt-1 w-full h-6 bg-white rounded-xl dark:bg-white">
              ...
              <div
                  ...
                  style={{ width: `${Math.min(userData.score || 15, 100)}%` }} // 100%를 넘지 않게 조정
              >
                  {Math.min(userData.score || 15, 100)}% 
              </div>
          </div>
