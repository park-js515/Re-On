...
|같이하기-백스테이지|같이하기-베틀룸|
|:---:|:---:|
| ![같이하기-백스테이지](./assets/gif/같이하기-백스테이지GIF.PNG) | ![같이하기-배틀룸GIF.gif](./assets/gif/같이하기-배틀룸GIF.gif) |
...
|마이페이지-업로드|투표해줘-일반|
|:---:|:---:|
| ![마이페이지-업로드](./assets/gif/마이페이지-업로드GIF.gif) | ![같이하기-배틀룸GIF.gif](./assets/gif/투표해줘-일반GIF.gif) |
|상단 메뉴바를 이용하여 원하는 서비스를 이용할 수 있습니다.|사용자 메뉴를 선택하여 로그인, 로그아웃, 마이페이지 이동이 가능합니다.|
...
|투표해줘-인기영상|혼자하기-게임|
|:---:|:---:|
| ![투표해줘-인기영상](./assets/gif/투표해줘-인기영상GIF.PNG) | ![혼자하기-게임](./assets/gif/혼자하기-게임GIF.gif) |
|상단 메뉴바를 이용하여 원하는 서비스를 이용할 수 있습니다.|사용자 메뉴를 선택하여 로그인, 로그아웃, 마이페이지 이동이 가능합니다.|
